    ...
    <section className="pt-32 pb-20 md:pt-40 md:pb-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-zinc-300 mb-8">The ultimate DDRaceNetwork client modification</p>
          <p className="text-zinc-400 mb-10 max-w-2xl mx-auto">
            Experience DDNet like never before with enhanced visuals, performance optimizations, and exclusive features
